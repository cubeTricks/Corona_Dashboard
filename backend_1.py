...
file_path=r'.\WHO-COVID-19-global-data_May23_db.csv'
file_path_vaccine=r'.\vaccination-data_May23_db.csv'
...
def country_data(selected_country,selected_date):
    df11=pd.DataFrame()
    country_name=[]
    ...
    x_axis_dates=x_axis_dates_today[0:len(x_axis_dates_today)]
    c_day1=[]
    selected_date=datetime.strptime(selected_date,'%Y-%m-%d')
    selected_date_minus_1=selected_date+timedelta(days=-1)
    selected_date_minus_2=selected_date+timedelta(days=-2)
    selected_date_str=selected_date.strftime('%Y-%m-%d')
    selected_date_minus_1_str=selected_date_minus_1.strftime('%Y-%m-%d')
    selected_date_minus_2_str=selected_date_minus_2.strftime('%Y-%m-%d')
    c_day1.append(selected_date_str)
    c_day1.append(selected_date_minus_1_str)
    c_day1.append(selected_date_minus_2_str)
...
#country_data('United States of America','2021-05-04')
#vaccine_data('India')
